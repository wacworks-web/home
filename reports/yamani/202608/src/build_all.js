...
/* ========== COVER ========== */
{
  ...
  s.addText([
    ...
    {text:"SECTION 03    BAG MANIA Yahoo!ショッピング店            /  10 slides", options:{breakLine:true}},
...
/* ---------- 7. 商品別TOP10 ---------- */
{
  ...
  table(s, ["順位","商品コード","商品名","売上金額","注文数","訪問者数","購買率"], D3.top10,
...
pres.writeFile({ fileName: "/tmp/claude-0/-home-user-home/7cd269b9-76ec-5b62-a114-e98ebb274bdd/scratchpad/WACWORKS_202608_ALL.pptx" }).then(f=>console.log("written:",f));
