...
## 顔付けルール（2026-09-15 ユーザー指示・恒久）

- **実在の俳優・有名人に似た顔を使わない。特に西島秀俊さん似の中年男性顔はNG**（S6夫役で「阿部寛似」と視聴者コメントの指摘もあり）。
- 全プロンプトのIMPORTANTブロックに次を必ず含める：
  "All faces are fictional AI-generated faces that must NOT resemble any real actor, celebrity or public figure."
- 中年男性キャラの記述は「彫りの深いイケメン俳優系」を避け、丸顔・柔和・平均的な顔立ちなど特徴を分散させる。
